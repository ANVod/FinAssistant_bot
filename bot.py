...
@dp.message(lambda message: message.text == "Регистрация в телеграм боте")
...
async def exchange_rates(message: Message):
    url = "https://v6.exchangerate-api.com/v6/b45c5a01387bc83b76fdf775/latest/USD"
...
@dp.message(lambda message: message.text == "Советы по экономии")
...
@dp.message(lambda message: message.text == "Личные финансы")
